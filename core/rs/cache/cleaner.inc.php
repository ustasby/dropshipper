...
class Cleaner
{
    ...
    {
        $this->dirs = array(
            self::CACHE_TYPE_COMMON => array(\Setup::$CACHE_FOLDER, \Setup::$CACHE_TABLE_FOLDER),
            self::CACHE_TYPE_MIN => array(\Setup::$PATH.\Setup::$COMPRESS_CSS_PATH, \Setup::$PATH.\Setup::$COMPRESS_JS_PATH),
            self::CACHE_TYPE_TPLCOMPILE => array(\Setup::$SM_COMPILE_PATH, \Setup::$SM_CACHE_PATH),
            self::CACHE_TYPE_TABLEACT => array(\Setup::$CACHE_TABLE_FOLDER)
        );
    } 
