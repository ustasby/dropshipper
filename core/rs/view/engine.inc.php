...
class Engine extends \Smarty
{
    ...
    function __construct()
    {
        ...
        $this->hooks = new \RS\View\Hooks($this, $this->site['id']);
    ...
    */
    function cacheOn($cache_id_str = null)
    {
        ...
        if ($this->cms_config['CACHE_BLOCK_ENABLED'] && !\RS\Debug\Mode::isEnabled()) {
            $this->caching = true;
        }
        return $this;
    }
        ...
        if (!\RS\Router\Manager::obj()->isAdminZone()) {
            ...
            if ($cache) {
                return \RS\Cache\Manager::obj()
                            ->request(array($this, __FUNCTION__), false, $this->site ? $this->site->id : '', $theme_str);
            } else {
