...
class Captcha extends AbstractType
{
    ...
    function __construct(array $options = null) {
        ...
        $this->setChecker(array($this, 'dependCheck'), \RS\Captcha\Manager::currentCaptcha()->errorText());
    }
    ...
    public function dependCheck($coreobj, $value, $errortext)
    {
        ...
        return call_user_func_array($callback, array($coreobj, $value, $context, \RS\Captcha\Manager::currentCaptcha()->errorText()));        
    }
