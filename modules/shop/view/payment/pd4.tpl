...
{assign var=sum value=explode('.', $order.totalcost)}
...
<tbody>
    ...
    <td style="{if $smarty.section.i.first}border-style: solid solid none; border-color: rgb(0, 0, 0) rgb(0, 0, 0) -moz-use-text-color; border-width: 1pt 1pt medium;{else}border: 1pt solid rgb(0, 0, 0);{/if}    " align="center">
        ...
        <table style="width: 122mm; margin-top: 3pt;" border="0" cellpadding="0" cellspacing="0">
            <tbody><tr>
                <td style="border-bottom: 1pt solid rgb(0, 0, 0); width: 60mm;">&nbsp;Оплата заказа №{$order.order_num} от {$order.dateof|dateformat:"@date"}</td>
        ...
        <table style="width: 122mm; margin-top: 3pt;" border="0" cellpadding="0" cellspacing="0">
            <tbody><tr>
                ...
                <td style="border-bottom: 1pt solid rgb(0, 0, 0);" width="100%">&nbsp;{$address->getLineView()}</td>
            </tr>
        </tbody></table>
        <table style="width: 122mm; margin-top: 3pt;" border="0" cellpadding="0" cellspacing="0">
            <tbody><tr>
        ...
        <table style="width: 122mm; margin-top: 3pt;" border="0" cellpadding="0" cellspacing="0">
            <tbody><tr>
                ...
                <td align="right">&nbsp;&nbsp;«{$order.dateof|dateformat:"%d"}» {$order.dateof|dateformat:"%v"} {$order.dateof|dateformat:"%Y"} г.</td>
            </tr>
        </tbody></table>
        <table style="width: 122mm; margin-top: 3pt;" border="0" cellpadding="0" cellspacing="0">
            <tbody><tr>
