...
{t alias="Уведомление пользователю при оформлении заказа" url=$url->getDomainStr()}Вы сделали заказ в интернет-магазине %url.<br>
Ваш заказ будет обработан в течение 1 рабочего дня.<br>
При необходимости, с Вами свяжется наш менеджер.{/t}<br>
...
<p>{t}С наилучшими пожеланиями, <br>администрация интернет магазина{/t} {$url->getDomainStr()}</p>