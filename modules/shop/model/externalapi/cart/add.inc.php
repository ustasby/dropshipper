...
*/
class Add extends \ExternalApi\Model\AbstractMethods\AbstractMethod
{
    const
        RIGHT_LOAD = 1;
    ...
    */
    ...
    {
        \Shop\Model\Cart::currentCart()->addProduct($id, $amount, $offer, $multioffers, $concomitants, $concomitants_amount);
