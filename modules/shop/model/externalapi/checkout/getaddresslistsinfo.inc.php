...
class GetAddressListsInfo extends \ExternalApi\Model\AbstractMethods\AbstractMethod
{
    ...
    */
    protected function process($token = null, $sections = array('country', 'regions', 'city'))
    {
        $result['response']['lists'] = array();
        ...
        if (in_array('city', $sections)){ //Список городов
           ...
           $region->getPropertyIterator()->append(array(
               'zipcode' => new \RS\Orm\Type\Varchar(array(
                    'maxLength' => 20,
                    'visible' => true,
                    'AppVisible' => true,
                    'cityVisible' => true,
