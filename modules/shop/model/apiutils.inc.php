    ...
    public static function getOrderDeliveryListSection($token, $order, $sortn)
    {
        ...
        if (!$shop_config['hide_delivery']){
            ...
            $delivery->getPropertyIterator()->append(array(
                'extrachange_discount_type' => new \RS\Orm\Type\Integer(array(
                    'visible' => true
                )),
                'extra_text' => new \RS\Orm\Type\Varchar(array(
                    'visible' => true
                )),
                'cost' => new \RS\Orm\Type\Varchar(array(
                    'visible' => true
                )),
                'additional_html' => new \RS\Orm\Type\Varchar(array(
                    'visible' => true
                )),
                'mobilesiteapp' => new \RS\Orm\Type\Integer(array(
                    'visible' => true,
                    'appVisible' => true
                )),
                'error' => new \RS\Orm\Type\Varchar(array(
                    'visible' => true
                )),
            ));
            ...
            if (!empty($delivery_list)){
                foreach ($delivery_list as &$delivery){
                    ...
                    */
                    ...
                    $delivery['additional_html'] = $delivery->getAddittionalHtml();     
