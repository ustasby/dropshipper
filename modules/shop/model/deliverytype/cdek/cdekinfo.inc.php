...
class CDEKInfo{
    ...
    private
        $tariff_type_compare = array( //Массив типа доставки и соответствия числу
           'дверь-дверь (Д-Д)' => 1,
           'дверь-склад (Д-С)' => 2, 
           'склад-дверь (С-Д)' => 3, 
           'склад-склад (С-С)' => 4, 
    ...
    */
    function getCSVInfo($filename, $format=array())
    {
    ...
    */
    ...
    {
        return $this->getCSVInfo(self::FILENAME_INT_TARIFF,array(
            'code',
            'title',
            'regim',
            'weight_limit',
    ...
    */ 
    ...
    {
        return $this->getCSVInfo(self::FILENAME_RUS_TARIFF,array(
            'code',
            'title',
            'regim',
            'weight_limit',
    ...
    */ 
    ...
    {
        return $this->getCSVInfo(self::FILENAME_RUS_CITIES,array(
            'code',
            'fullname',
            'title',
            'region',
    ...
    */ 
    ...
    {
        return $this->getCSVInfo(self::FILENAME_KAZ_CITIES,array(
            'code',
            'fullname',
            'title',
            'region',
    ...
    */ 
    ...
    {
        return $this->getCSVInfo(self::FILENAME_UKR_CITIES,array(
            'code',
            'fullname',
            'title',
            'region',
    ...
    */ 
    ...
    {
        return $this->getCSVInfo(self::FILENAME_BLR_CITIES,array(
            'code',
            'fullname',
            'title',
            'region',
    ...
    */
    function getAllCities()
    {
        ...
        if (!empty($cities)){
           usort($cities,array($this,'strCitySort')); 
           $arr[t('Россия')] = $cities; 
        }
    ...
    */ 
    ...
    {
        $_this = new self();
        return $_this->getCSVInfo(self::FILENAME_ADD_SERVICES,array(
            'code',
            'agree',
            'title',
            'description',
    ...
    */ 
    ...
    {
        $_this = new self();
        return $_this->getCSVInfo(self::FILENAME_ALL_SERVICES,array(
            'code',
            'agree',
            'title',
            'description',
