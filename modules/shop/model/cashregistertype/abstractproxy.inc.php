...
abstract class AbstractProxy
{
     ...
     * @return string
     */
    abstract protected static function getApiVersionClass();
    ...
    {
        $func = array($this->api_instance, $name);
        if (is_callable($func)) {
            return call_user_func_array($func, $arguments);
        }

        throw new \RS\Exception(t('Не найден метод %0 в классе %1', array($name, get_class($this->api_instance))));
    }
    ...
    public static function __callStatic($name, $arguments)
    {
        ...
        throw new \RS\Exception(t('Не найден статический метод %0 в классе %1', array($name, $class)));
    }
}