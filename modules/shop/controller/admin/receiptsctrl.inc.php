...
class ReceiptsCtrl extends \RS\Controller\Admin\Crud
{
    ...
    function helperIndex()
    {
             ...
             'Items' => array(
                 new ToolbarButton\Dropdown(array(
                     array(
                         ...
                         'attr' => array(
                             'href' => $this->router->getAdminUrl(false, array('transaction_id' => $transaction_id, 'referer' => $this->url->selfUri()), 'shop-correctionreceiptctrl'),
        ...
        //Статусы
        $status_list = array('' => t('Любой')) + $receipt->__status->getList();
        $type_list = array('' => t('Любой')) + $receipt->__type->getList();
