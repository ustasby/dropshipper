...
class Reservation extends \RS\Controller\Admin\Widget
{
    ...
    function actionIndex()
    {
        ...
        $filter = $this->url->convert( $this->myRequest('filter', TYPE_STRING, $default_filter), array('open', 'close'));
        ...
        $paginator = new \RS\Helper\Paginator($page, $reservation_api->getListCount(), $pageSize, 'main.admin', array('mod_controller' => $this->getUrlName()));
