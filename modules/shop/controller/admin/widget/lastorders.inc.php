...
class LastOrders extends \RS\Controller\Admin\Widget
{
    ...
    function actionIndex()
    {
        ...
        $filter = $this->url->convert( $this->myRequest('filter', TYPE_STRING, $default_filter), array('active', 'all'));
        ...
        $paginator = new \RS\Helper\Paginator($page, $order_api->getListCount(), $pageSize, 'main.admin', array('mod_controller' => $this->getUrlName()));
