...
class Handlers extends \RS\Event\HandlerAbstract
{
    ...
    {
        $banner->getPropertyIterator()->append(array(
            t('Мобильное приложение'),
                '_mobile_banner_type_' => new Type\Varchar(array(
                    'description' => t('Тип баннера'),
                    'template' => '%pushsender%/form/banner/type.tpl',
                    'runtime' => true
                )),
                'mobile_banner_type' => new Type\Varchar(array(
                    'description' => t('Тип баннера'),
    ...
    {        
        $orm_user->getPropertyIterator()->append(array(
            t('Push-уведомления'),
                'push_lock' => new Type\ArrayList(array(
