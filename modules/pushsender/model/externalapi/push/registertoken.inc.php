    ...
    */
    ...
    private function getClientIdValidator()
    {
        if ($this->client_id_validator === null){
            $this->client_id_validator = new \ExternalApi\Model\Validator\ValidateArray(array(
    ...
    private function getDeviceValidator()
    {
        if ($this->device_validator === null){
            $this->device_validator = new \ExternalApi\Model\Validator\ValidateArray(array(
                'uuid' => array(
                    '@require' => true,
     ...
     */
    protected function process($push_token, $token = null, $client_id = null, $device = array(), $update_user_id = null)
    {
