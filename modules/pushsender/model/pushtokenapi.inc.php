...
class PushTokenApi extends \RS\Module\AbstractModel\EntityList
{
    ...
    {
        parent::__construct(new Orm\PushToken(), array(
     ...
     * @throws \RS\Orm\Exception
     */
    public static function registerUserToken($push_token, $app, $user_id = null, $device = array(), $update_user_id = null)
    {
    ...
    */
    function sendPushMessageToUsers(\PushSender\Model\Orm\PushTokenMessage $push_message, $ids)
    {                                                          
        $push = new \MobileSiteApp\Model\Push\MessageToUsers();
        $push->init($push_message, $ids);
        $push->send();    
    }
}