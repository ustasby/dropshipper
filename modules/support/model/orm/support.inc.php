...
class Support extends \RS\Orm\OrmObject
{
    ...
    function _init()
    {
        parent::_init()->append(array(
            ...
            'topic'   => new Type\Varchar(array(
                'description' => t('Тема'),
                'checker' => array(array(__CLASS__, 'checkTopic'), t('Укажите, пожалуйста, тему')),
                'visible' => false
            )),
            ...
            'message' => new Type\Text(array(
                ...
                'checker' => array('chkEmpty', t('Не задан вопрос'))
            )),
            ...
            'topic_id' => new Type\Integer(array(
    ...
    function updateTopicCounts()
    {
        ...
        $total_msg = $q->from($this)
                        ->where( array('topic_id' => $this['topic_id']) )
                        ->count();
