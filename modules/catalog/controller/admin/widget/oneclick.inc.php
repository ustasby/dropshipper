...
{
    protected
        $info_title = 'Покупки в 1 клик',
        $info_description = 'Отображает список заявок на товар';
    ...
    function actionIndex()
    {
        ...
        $filter = $this->url->convert( $this->myRequest('filter', TYPE_STRING, $default_filter), array('new', 'viewed'));
        ...
        $paginator = new \RS\Helper\Paginator($page, $oneclick_api->getListCount(), $pageSize, 'main.admin', array('mod_controller' => $this->getUrlName()));
