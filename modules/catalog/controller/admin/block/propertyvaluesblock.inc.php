...
class PropertyValuesBlock extends \RS\Controller\Admin\Block
{
    ...
    */
    function actionIndex()
    {
        ...
        $this->property_api->setFilter(array(
            'prop_id' => $this->property['id']
        ));
        
        $this->property_api->applyFormFilter($filter, array(
            'prop_id' => $this->property['id'],
        ...
        $paginator = new \RS\Html\Paginator\Element($total, $url_pattern, array(
            'pageKey' => 'pvl_page',
    ...
    */
    function actionEdit()
    {
        ...
        if ($this->url->isPost()) {
            ...
            $this->result->setSuccess( $this->property_api->save($value_id ?: null, array('id' => $value_id) ) );
