...
*/
class OfferBlock extends \RS\Controller\Admin\Block
{
    const
        PAGE_SIZE = 50;
    ...
    function init()
    {
        $this->product = $this->getParam('product', new \Catalog\Model\Orm\Product);
    ...
    */
    function actionOfferDelete()
    {
        ...
        if ($this->offer_api->multiDelete($offers_id)) {
            ...
            return $this->result
                            ->setSuccess(false)
                            ->addEMessage($this->offer_api->getErrorsStr());
        }
    }
