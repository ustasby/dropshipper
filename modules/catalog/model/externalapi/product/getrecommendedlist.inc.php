...
class GetRecommendedList extends \ExternalApi\Model\AbstractMethods\AbstractGet
{
    ...
    */
    ...
    protected function addDirData($recommended)
    {
        ...
        $product->getPropertyIterator()->append(array(
            ...
            'category' => new \RS\Orm\Type\Mixed(array(
    ...
    protected function addImageData($recommended)
    {
        ...
        if (in_array('image', $this->method_params['sections'])) {
            $this->product_api->getElement()->getPropertyIterator()->append(array(
    ...
    */
    function process($token = null,
                     ...
                     $only_in_stock = 1,
                     $sections = array('image', 'cost', 'property', 'concomitant', 'unit', 'current_currency'))
    {
        //Загруженный товар
