...
class Get extends \ExternalApi\Model\AbstractMethods\AbstractGet
{
    ...
    * @return array
    */
    function process($token = null, $product_id, $sections = array('image', 'cost', 'recommended', 'concomitant', 'property', 'current_currency'))
    {
        ...
        if (in_array('cost', $sections)) {
            ...
            \Catalog\Model\ApiUtils::addProductCostValuesSection(array($this->object));
        ...
        if (in_array('property', $sections)) {
            $this->object->getPropertyIterator()->append(array(
