...
class Product extends \Comments\Model\Abstracttype
{
    ...
    */
    ...
    {
        return \RS\Router\Manager::obj()->getAdminUrl('edit', array('id' => $this->comment['aid']), 'catalog-ctrl', $absolute);
    }
    ...
    */
    function getLinkedObject()
    {
        if (!isset($this->product)) {
            $this->product = new \Catalog\Model\Orm\Product($this->comment['aid']);
        }
        return $this->product;
    }
