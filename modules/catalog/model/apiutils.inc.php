...
class ApiUtils
{
    ...
    */
    private static function extendFiltersObjects()
    {
        ...
        $prop_group->getPropertyIterator()->append(array(
            'properties' => new \RS\Orm\Type\ArrayList(array(
                'description' => t('Характеристики со значениями'),
                'appVisible' => true
            ))
        )); 
        $prop_item = new \Catalog\Model\Orm\Property\Item();
        $prop_item->getPropertyIterator()->append(array(
            'allowed_values' => new \RS\Orm\Type\ArrayList(array(
                'description' => t('Характеристики со значениями'),
                'appVisible' => true
            )),
            ...
            'group_id' => new \RS\Orm\Type\Integer(array(
                'maxLength' => '11',
                'runtime' => true,
                'appVisible' => true
            )),
            'public' => new \RS\Orm\Type\Integer(array(
                'runtime' => true,
                'appVisible' => true
            )),
            'interval_from' => new  \RS\Orm\Type\Real(array(
                'description' => t('Минимальное значение'),
                'Attr' => array(array('size' => 8)),
                'appVisible' => true,
                'runtime' => true
            )),
            'interval_to' => new  \RS\Orm\Type\Real(array(
        ...
        $prop_item_value->getPropertyIterator()->append(array(
            'color' => new \RS\Orm\Type\Color(array(
                'description' => t('Цвет'),
                'appVisible' => true,
            ))
        ));
