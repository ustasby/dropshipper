...
{    
    ...
    */
    public function getAppRights()
    {
        ...
        return array(
            'user.get' => array(User\Get::RIGHT_LOAD_SELF),
            'user.getCourierList' => self::FULL_RIGHTS,
            
            'order.get' => array_merge(array(Order\Get::RIGHT_LOAD), $courier_rights),
            'order.getList' => array_merge(array(Order\GetList::RIGHT_LOAD), $courier_rights),
            'order.sellStatistic' => array(Order\SellStatistic::RIGHT_LOAD),
            'order.sellStatisticMonth' => array(Order\SellStatistic::RIGHT_LOAD),
            'order.statisticAvgOrderSum' => self::FULL_RIGHTS,
            'order.sellStatisticYears' => self::FULL_RIGHTS,
            'order.update' => array_merge(array(Order\Update::RIGHT_UPDATE), $courier_rights),
