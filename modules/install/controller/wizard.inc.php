...
{    
            ...
            if ($license == 'license') {
                ...
                if (!$orm_license->insert()) {
                    ...
                    if ($orm_license->isNeedActivation()) {
                        ...
                        $this->redirect($this->router->getUrl('install', array('step' => '4a')));
                    }
                }
            }
            if ($result === true) {
                ...
                $this->redirect($this->router->getUrl('install', array('step' => '5')));
            }
        }
    ...
    function actionCheckLicense()
    {
        ...
        if ($res === true) {
            $result = array('success' => true, 'result' => t('Ключ корректный'));
        } else {
            $result = array('success' => false, 'result' => $res);
        }
    ...
    function actionChangeLang()
    {
        ...
        $this->redirect($this->router->getUrl('install'));
    }
