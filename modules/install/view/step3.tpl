...
<form method="POST" id="config-form">
    <table class="config-table">
        <tr class="first">
            ...
            <td class="value"><input type="text" name="db_host" value="127.0.0.1" data-check-pattern=".+" data-check-error="{t}Не заполнено обязательное поле Хост{/t}">
        ...
        <tr>
            ...
            <td class="value"><input type="text" name="db_name" value="readyscript" data-check-pattern=".+" data-check-error="{t}Необходимо указать имя базы данных{/t}">
            <span class="field-error" data-field="db_name"></span>
            </td>
        </tr>    
        <tr>
            <td class="key">{t}Пользователь{/t}</td>
            <td class="value"><input type="text" name="db_user" value="root" data-check-pattern=".+" data-check-error="{t}Необходимо указать имя пользователя базы данных{/t}">
    ...
    <table class="config-table">
        <tr class="first">
            ...
            <td class="value">
                <input type="text" name="supervisor_email" data-check-pattern="{literal}^[\.\-_A-Za-z0-9]+?@[\.\-A-Za-z0-9]+?\.[A-Za-z0-9]{2,6}${/literal}" data-check-error="{t}Необходимо указать корректный e-mail администратора{/t}">
        ...
        <tr>
            ...
            <td class="value"><input type="password" name="supervisor_pass" data-check-pattern="{literal}^.{6,}${/literal}" data-check-error="{t}Пароль должен содержать не менее 6 знаков{/t}">
        ...
        <tr>
            ...
            <td class="value"><input type="password" name="supervisor_pass_confirm" data-check-error="{t}Неверный повтор пароля{/t}">
    ...
    <div class="change-admin-section">
        ...
        http://{$Setup.DOMAIN}/ <input type="text" name="admin_section" value="admin" id="supervisor_pass_confirm" maxlength="20" data-check-pattern="^[a-z0-9\-_]+$" data-check-error="{t}В имени могут использоваться только цифры, английские буквы, символы '-_' тире и подчеркивания{/t}"> /
        <span class="field-error" data-field="admin_section"></span>
    </div>
    
<div class="hr sim"></div>
<div>
    <input type="checkbox" name="set_demo_data" value="1" id="demodata" checked>&nbsp;&nbsp;<label for="demodata"><strong>{t}Устанавливать демонстрационные данные{/t}</strong></label>
</div>
</form>
