...
<form method="POST" id="step-form">
    ...
    <div class="case" name="">
        ...
        <div class="more">
            ...
            <p>{t}Пробная версия может использоваться в течении 30 дней, и не содержит каких-либо ограничений функционала. После истечения пробного периода, Вы должны приобрести лицензию или удалить продукт.{/t}</p>
        </div>
    </div>
</form>
