...
class Config extends \ExternalApi\Model\AbstractMethods\AbstractAuthorizedMethod
{
    ...
    */
                               ...
                               $lon = "0")
    {
        ...
        //Модуль магазин
        if (\RS\Module\Manager::staticModuleExists('shop') && \RS\Module\Manager::staticModuleEnabled('shop')){
        ...
        $response['response']['geolocation']['address'] = $this->getAddressFromGeoCity();  
        
        //Дополнительные поля
        $response['response']['additional_fields']['buyoneclick'] = \Shop\Model\ApiUtils::getAdditionalBuyOneClickFieldsSection();
