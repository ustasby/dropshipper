...
class TemplateManager{
    ...
    public static function getTemplatesListFromModules()
    {
        ...
        if ($templates === null){
            $result    = \RS\Event\Manager::fire('mobilesiteapp.gettemplates', array());
    ...
    */
    ...
    {
        return str_replace(array("../", "./"), array("", ""), $template_path);
    }
            ...
            foreach ($paths as $path) {
                ...
                if (is_dir($file_or_dir)){
                    ...
                    if ($ext == 'tpl'){ //Берём только tpl файлы
                        ...
                        $paths_array[] = ltrim(str_replace(array($exclude_path, ".tpl"), array("", ""), $file_or_dir), "/");
                    }
                }
            }
        }
