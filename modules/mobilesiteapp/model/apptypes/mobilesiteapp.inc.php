    ...
    */
    public function getAppRights()
    {
        return array(
            ...
            'order.getList' => array(\Shop\Model\ExternalApi\Order\GetList::RIGHT_LOAD),
            'order.get'     => array(\Shop\Model\ExternalApi\Order\Get::RIGHT_LOAD),
            'order.additionalfields' => self::FULL_RIGHTS,
            'order.sellstatistic' => self::FULL_RIGHTS,
            'order.sellstatisticmonth' => self::FULL_RIGHTS,
            'order.sellstatisticyears' => self::FULL_RIGHTS,
            'order.statisticavgordersum' => self::FULL_RIGHTS,
            'order.update'     => self::FULL_RIGHTS,
