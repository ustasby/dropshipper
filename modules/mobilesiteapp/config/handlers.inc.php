...
class Handlers extends \RS\Event\HandlerAbstract
{
        ...
        if ($config->enable_app_sticker && !$router->isAdminZone()) {
            ...
            if (method_exists($site, 'getMainDomain')) { //Для совместимости со старыми версиями RS
                ...
                if (isset($data['googleplay_app_id']) && isset($data['google_icon'])) {
                    ...
                    $app->addCss($data['google_icon'], null, BP_ROOT, true, array(
    ...
    */
    public static function ormInitMenuMenu(\Menu\Model\Orm\Menu $menu)
    {
        $menu->getPropertyIterator()->append(array(
            t('Мобильное приложение'),
                'mobile_public' => new Type\Integer(array(
                    'maxLength' => '1',
                    'default' => 0,
                ...
                'mobile_image' => new Type\Varchar(array(
                    'maxLength' => '50',
    ...
    {
        $category->getPropertyIterator()->append(array(
            t('Мобильное приложение'),
            'mobile_public' => new Type\Integer(array(
                'maxLength' => '1',
                'default' => 0,
    ...
    */
    public static function ormInitCatalogDir(\Catalog\Model\Orm\Dir $dir)
    {
        $dir->getPropertyIterator()->append(array(
            t('Мобильное приложение'),
                'mobile_background_color' => new Type\Color(array(
                    'description' => t('Цвет фона для планшета'),
                    'maxLength' => '11',
                    'default' => '#E0E0E0',
                    'appVisible' => true
                )),  
                'mobile_tablet_background_image' => new Type\Image(array(
                ...
                'mobile_tablet_icon' => new Type\Image(array(
    ...
    */
    public static function ormInitShopDelivery(\Shop\Model\Orm\Delivery $delivery)
    {
        $delivery->getPropertyIterator()->append(array(
            'mobilesiteapp_additional_html' => new Type\Mixed(array(
    ...
    */
    ...
    {
        //Мобильный сайт
        $routes[] = new \RS\Router\Route('mobilesiteapp-front-gate', array(
            '/mobilesiteapp/{Act}/',
            '/mobilesiteapp/'
