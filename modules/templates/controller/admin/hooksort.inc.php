...
{    
    ...
    function actionIndex()
    {
        ...
        $template_hooks = $group->getData('hooksort', 'hooks', array());
        ...
        $collection->setBottomToolbar(new \RS\Html\Toolbar\Element(array(
            'Items' => array(
                new \RS\Html\Toolbar\Button\SaveForm(),
                new \RS\Html\Toolbar\Button\Cancel(''),
                new \RS\Html\Toolbar\Button\Button($this->router->getAdminUrl('ajaxresetsort', array('toolgroup' => $toolgroup)), t('Сброс'), array(
                    'attr' => array(
