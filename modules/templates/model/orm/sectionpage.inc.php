    ...
    function _init()
    {
        ...
        $this->getPropertyIterator()->append(array(
            ...
            'route_id' => new Type\Varchar(array(
                ...
                'List' => array(array(__CLASS__, 'getRouteSelectList')),
            ...
            'inherit' => new Type\Integer(array(
                'maxLength' => 1,
                'default' => 1,
        ...
        $this->addIndex(array('site_id', 'route_id', 'context'), self::INDEX_UNIQUE);
    }
