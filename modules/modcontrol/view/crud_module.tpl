                                ...
                                <div class="controller_info">
                                    ...
                                    <ul class="list-with-help">
                                        {foreach from=$module_item->getTools() item=item}
                                            <li><a {if isset($item.target)}target="{$item.target}"{/if} {if !empty($item.confirm)}data-confirm-text="{$item.confirm}"{/if} class="{if $item.class}{$item.class}{else}crud-get{/if}" href="{$item.url}" style="text-decoration:underline">{$item.title}</a>
