    ...
    function helperIndex()
    {
        ...
        $helper->setTable(new Table\Element(array(
            'Columns' => array(
                ...
                new TableType\Usertpl('routeview', t('Маршрут'), $this->mod_tpl.'pageseo_column_route.tpl', array('hidden' => true)),
                new TableType\Usertpl('', t('Мета-теги'), $this->mod_tpl.'pageseo_column_meta.tpl', array('TdAttr' => array('class' => 'cell-small'))),
