                                 ...
                                 \Alerts\Model\Types\InterfaceDesktopApp
{
    ...
    */
    ...
    public function getNoticeDataEmail()
    {
        ...
        $notice_data->subject   = t('Поступил новый комментарий на сайте %0 №-%1', array(\RS\Http\Request::commonInstance()->getDomainStr()));
    ...
    */
    public function getNoticeDataDesktopApp()
    {
        ...
        $notice_data->short_message = t('%type %nl%comment', array(
            'nl' => "\n",
        ...
        $notice_data->link = \RS\Router\Manager::obj()->getAdminUrl('edit', array('id' => $this->comment['id']), 'comments-ctrl', true);
