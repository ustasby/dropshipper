...
class LogApi extends \RS\Module\AbstractModel\EntityList
{
    ...
    * 
    * @param string | object $class - Класс события наследник MUsers_Model_LogtypeAbstract
    ...
    * @param mixed $user_id - фильтр по id пользователя
    ...
    * @return массив наследников MUsers_Model_LogtypeAbstract
    */
