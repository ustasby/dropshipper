...
class Install extends \RS\Module\AbstractInstall
{
    function install()
    {
        ...
        if ($result) {
            ...
            $group->setMenuAccess(array(Orm\AccessMenu::FULL_USER_ACCESS), Orm\AccessMenu::USER_MENU_TYPE);
            $group->setMenuAccess(array(Orm\AccessMenu::FULL_ADMIN_ACCESS), Orm\AccessMenu::ADMIN_MENU_TYPE);
            $group->setModuleAccess(array(Orm\AccessModule::FULL_MODULE_ACCESS => 255));
            ...
            $group->setMenuAccess(array(Orm\AccessMenu::FULL_USER_ACCESS));
            $group->setModuleAccess(array(Orm\AccessModule::FULL_MODULE_ACCESS => 255));
            ...
            $user->linkGroup(array(Orm\UserGroup::GROUP_SUPERVISOR));
        }
        return $result;
    }
