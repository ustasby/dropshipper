...
<div class="orderViewCaption oh">
    <div class="fleft">
        <p class="orderNumber">{t number=$order.order_num}Заказ №%number{/t}</p>
...
<div class="formLine alignCenter">
    <a href="{$router->getUrl('shop-front-cartpage', ['Act'=>'repeatOrder', 'order_num' => $order.order_num])}" rel="nofollow"
            class="formSave colorButton repeatOrder orderViewRepeatOrder">{t}Повторить заказ{/t}</a>
