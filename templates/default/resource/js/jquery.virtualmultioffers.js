...
(function( $ ){
    $.fn.virtualMultioffers = function( method ) {
        var defaults = {
            ...
            notAvaliable           : 'notAvaliable',                  //Селектор означающий, что товар нельзя приобрести
        ...
        return this.each(function() {
            ...
            */
            var changeVirtualMultiOffers = function() {
                ...
                if (virtualMultiOffer){ //Если найдено, то переключим товар
                    ...
                    $(data.options.target).addClass('notAvaliable');
                }
            };
            ...
            */
            var getSelectedValues = function()
            {
                ...
                $("select" + data.options.virtualMultiOfferName, context).each(function(i){
                ...
                $("input" + data.options.virtualMultiOfferName + ":checked", context).each(function(i){
