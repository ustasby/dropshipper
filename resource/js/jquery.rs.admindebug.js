...
(function($) {
    ...
    $.widget('rs.rsAdminFunctions', {
        ...
        _action_post: function(e) {
            ...
            if (!total || (confirmText && !confirm( confirmText.replace('%count', total) )) ) {
                return false;
            }
                ...
                if (first_selected.length){
                    ...
                    $.each(elements_range, function(k, key) {
                        ...
                        if (need_be_selected){
                            ...
                            $(search_tag + " [type='checkbox']", wrapper).prop('checked', true);
                        }else{
                            $(search_tag + " .chk", wrapper).removeClass('checked');
                            $(search_tag + " [type='checkbox']", wrapper).prop('checked', false);
                        }
                    });
                }
            }
